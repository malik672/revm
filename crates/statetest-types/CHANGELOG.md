...
## [15.0.0](https://github.com/malik672/revm/compare/revm-statetest-types-v14.0.0...revm-statetest-types-v15.0.0) - 2026-02-06

### Added

- *(statetest-types)* add slot_number support (EIP-7843) ([#3391](https://github.com/malik672/revm/pull/3391))
- Implement EIP-7843 SLOTNUM opcode for Amsterdam ([#3340](https://github.com/malik672/revm/pull/3340))

### Other

- *(statetest-types)* add BPO2ToAmsterdamAtTime15k fork spec ([#3397](https://github.com/malik672/revm/pull/3397))
